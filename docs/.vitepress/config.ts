...
const site = 'https://smtp-mcp.ni-c.de';
const description =
  'An MCP server that sends mail over SMTP: off until you enable it, limited to recipients you allowlisted, and with a person approving every single message.';
...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { property: 'og:site_name', content: 'smtp-mcp' }],
    ['meta', { property: 'og:title', content: 'smtp-mcp' }],
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'Reference', link: '/reference/tools', activeMatch: '/reference/' },
      {
        ...
        items: [
          ...
          { text: 'Releases', link: 'https://github.com/ni-c/smtp-mcp/releases' },
          { text: 'npm package', link: 'https://www.npmjs.com/package/@ni-c/smtp-mcp' },
        ],
      },
    ],
      ...
      '/guide/': [
        {
          text: 'Introduction',
          items: [
            { text: 'What is smtp-mcp?', link: '/guide/' },
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/ni-c/smtp-mcp' },
      {
        icon: {
    ...
    editLink: {
      pattern: 'https://github.com/ni-c/smtp-mcp/edit/main/docs/:path',
